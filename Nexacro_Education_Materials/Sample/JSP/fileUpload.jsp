...
<%
	...
	String sRealPath = request.getSession().getServletContext().getRealPath("/nexacroN/");	//http://localhost:8080/edu/nexacroN/
	System.out.println(request.getSession().getServletContext().getRealPath("/nexacroN/"));
	System.out.println(request.getSession().getServletContext().getRealPath("/nexacroN"));
