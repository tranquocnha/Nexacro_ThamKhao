...
try {    
	...
	try { 
		...
		DataSet ds2 = new DataSet("out_dept");
		ds2.addColumn("DEPT_CD"    ,DataTypes.STRING  ,(short)10 );
		ds2.addColumn("DEPT_NAME"  ,DataTypes.STRING  ,(short)10 );
			
		while(rs2.next())
		{
			int row = ds2.newRow();
			ds2.set(row ,"DEPT_CD"       ,rs2.getString("DEPT_CD")  );
			ds2.set(row ,"DEPT_NAME"     ,rs2.getString("DEPT_NAME")   );
		}
		
		out_pData.addDataSet(ds);
		out_pData.addDataSet(ds2);
